...
type AssetType = {
    ...
    ibc: {
        ...
        source_denom?: string | undefined;
        dst_channel?: string | undefined;
    } | undefined;
};
    ...
    return (
      <Box as="label">
        ...
        <Box
          {...checkbox}
          cursor="pointer"
          bg={blackAlpha300_or_whiteAlpha300}
          borderRadius="full"
          _checked={{
            bg: 'primary.500',
            color: 'white'
  ...
  const Setting = () => {
    ...
    return (
      ...
      >
        <PopoverTrigger>
          <Button
            ...
            color={
              isOpen
                ? 'orange.300'
                : blackAlpha400_or_whiteAlpha500
            }
            transition="all .5s"
            _hover={{
              color: isOpen
                ? 'orange.200'
                : blackAlpha500_or_whiteAlpha600
            }}
          ...
          >
            <Icon
              ...
              w={8}
              h={8}
              color={gray100_or_whiteAlpha300}
            />
            <Icon
              position="absolute"
              top={0}
        ...
        <PopoverContent
          bg={white_or_black}
          borderColor={blackAlpha200_or_whiteAlpha400}
          boxShadow="md"
          w="fit-content"
          right={4}
        >
          <PopoverBody p={{ base: 6, sm: 8 }}>
            ...
            <Text
              fontWeight="semibold"
              color={blackAlpha500_or_whiteAlpha600}
  ...
  const FromToken = ({
    ...
    const customStyles = {
      ...
      option: (provided: SystemStyleObject, state: { isSelected: boolean }) => ({
        ...
        borderRadius: 'lg',
        bg: state.isSelected
          ? primary100_or_primary500
          : 'transparent',
        color: 'inherit',
        _hover: {
          bg: state.isSelected
            ? primary100_or_primary500
            : blackAlpha200_or_whiteAlpha200
        },
        _disabled: {
          ...
          {fromItem ? (
            <Box flex={1}>
              <Editable
                ...
                color={
                  tokenInputValue === '0'
                    ? blackAlpha700_or_whiteAlpha700
                    : blackAlpha800_or_whiteAlpha800
                }
                mb={{ base: 1, sm: 2 }}
                placeholder="0"
              >
              ...
              <Text
                ...
                color={
                  tokenInputValue === '0'
                    ? blackAlpha600_or_whiteAlpha600
                    : blackAlpha700_or_whiteAlpha700
                }
                mb={0}
              >
        ...
        {!isOpen && (
          <Flex justify="center" align="center" boxShadow="base">
            <Box
              ...
              zIndex={5}
              bottom={{ base: -8, sm: -10 }}
              color={blackAlpha300_or_whiteAlpha600}
              onClick={() => {
          ...
          {toItem ? (
            ...
            >
              <Text
                ...
                fontWeight="bold"
                color={blackAlpha800_or_whiteAlpha800}
                textAlign="end"
                wordBreak="break-word"
                mb={{ base: 1, sm: 2 }}
                mr={{ base: 0, md: 2 }}
    ...
    useEffect(() => {
      ...
      if (!loading) {
        ...
        const filteredAssetList = assetList
            .reduce<AssetType[]>((acc, item) => {
                if (item !== undefined && item.imgSrc) {
                    acc.push(item);
                }
                return acc;
            }, [])
        ...
        setFromItem(filteredAssetList[0]);
        setToItem(filteredAssetList[3]);
